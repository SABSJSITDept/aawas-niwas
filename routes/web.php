...
// Group Booking Routes - Specific routes before pattern routes
...
// Family Booking Routes - Specific routes before pattern routes
...
Route::get('/thank-you/{booking_id?}', [GroupBookingController::class, 'thankyou'])
    ->name('thankyou');
...
// Define a route to fetch room details via AJAX
...
Route::get('/room-report/pdf', [RoomReportController::class, 'downloadPdf'])->name('room.report.pdf'); // ✅ Add this line
...
Route::get('/admin/daily-room-report', [DailyRoomReportController::class, 'show'])
    ->name('admin.daily-room-report');
Route::get('/admin/daily-room-report/download', [DailyRoomReportController::class, 'download'])
    ->name('admin.daily-room-report.download');
    Route::get('/daily-room-report/notallotted-pdf', [DailyRoomReportController::class, 'notAllottedPdf'])
        ->name('admin.daily-room-report.notallotted-pdf');

        Route::get('/admin/checkin-report', [CheckinStatsController::class, 'index'])
        ->name('admin.checkin.report');
...
// API routes for registration management
