...
<div class="min-h-screen bg-slate-50 font-['Inter'] pt-4 pb-20">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
        ...
        <!-- 1. Hero Banner -->
        <div class="group relative rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-200 mb-8 cursor-pointer bg-white" data-bs-toggle="modal" data-bs-target="#imageModal">
        ...
        <!-- Additional Banners -->
        <div class="group relative rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 mb-6 cursor-pointer" data-bs-toggle="modal" data-bs-target="#imageModal">
            <img src="{{ asset('images/3.jpeg') }}" alt="Guidelines" class="w-full h-auto object-cover transition-transform duration-500 group-hover:scale-[1.02]" data-img="{{ asset('images/3.jpeg') }}">
            <div class="absolute inset-0 bg-black/0 group-hover:bg-black/5 transition-colors duration-300 pointer-events-none"></div>
        </div>

        <div class="group relative rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer" data-bs-toggle="modal" data-bs-target="#imageModal">
            <img src="{{ asset('images/4.jpeg') }}" alt="Guidelines" class="w-full h-auto object-cover transition-transform duration-500 group-hover:scale-[1.02]" data-img="{{ asset('images/4.jpeg') }}">
            <div class="absolute inset-0 bg-black/0 group-hover:bg-black/5 transition-colors duration-300 pointer-events-none"></div>
        </div>
